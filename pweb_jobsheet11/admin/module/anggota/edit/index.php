<div class="container-fluid">
    <div class="row">
        ...
        // Query disesuaikan untuk PostgreSQL (double quotes untuk "user" dan JOIN query)
        $query = "SELECT a.*, j.jabatan, u.username FROM anggota a JOIN jabatan j ON a.jabatan_id = j.id JOIN \"user\" u ON a.user_id = u.id AND a.user_id = '$id'";
